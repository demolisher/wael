...
if (isset($_POST['update_student'])) {
    ...
    $needCode = $sl_compound['id'] . "-" . $sl_path['id'] . "-" . $sl_level['id'] . "-" . $sl_gender['id'];
    ...
    if (mysqli_num_rows($select_need) > 0) {
        ...
        $query = "UPDATE needs SET compound='$compound', path='$path', level='$level', gender='$gender', need_code='$needCode', comple='$comple' 
                WHERE id='$student_id'";
...
if (isset($_POST['save_student'])) {
    ...
    if (mysqli_num_rows($select_need) > 0) {
        ...
        $query = "INSERT INTO needs (compound, path, level, gender, comple, need_code) VALUES ('$compound', '$path', '$level', '$gender','$comple','$needCode')";
        $query_run = mysqli_query($conn, $query);
