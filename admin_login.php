...
if (isset($_POST['login'])) {
    ...
    $select = mysqli_query($conn, "SELECT * FROM `users` WHERE rule = 'admin' AND email = '$email' AND pass = '$password'") or die('خطأ اتصال بيانات');
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                ...
                <div class="card-body" style="padding:20px 40px">
                    ...
                    <p class="text-center text-white mt-3" style="font-size:18px">فكــرة وتنفيــذ .. الأستــاذ وائل العمري</p>
                </div>
            </div>
<!--             <div class="logos">
                <div style="width:28%;padding-left:5px"><a href="https://schools.madrasati.sa/"><img src="dist/img/madrasati.png" alt=""></a></div>
                <div style="width:20%;padding-left:5px"><a href="https://noor.moe.gov.sa/"><img src="dist/img/nor.png" alt=""></a></div>
                <div style="width:20%;padding-left:5px"><a href="https://frsprod.moe.gov.sa/"><img src="dist/img/faris.png" alt=""></a></div>
                <div style="width:28%"><a href="https://moe.gov.sa/ar"><img src="dist/img/education.png" alt=""></a></div>
            </div> -->
        </div>
    </div>
